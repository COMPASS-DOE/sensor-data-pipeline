...
var_md_for_insert <- paste(sprintf("%-20s", c("research_name", L1_VAR_MD$research_name)),
                           sprintf("%-10s", c("Units", L1_VAR_MD$final_units)),
                           sprintf("%-12s", c("Bounds", paste0(L1_VAR_MD$low_bound, ", ", L1_VAR_MD$high_bound))),
                           c("Description", L1_VAR_MD$description))
