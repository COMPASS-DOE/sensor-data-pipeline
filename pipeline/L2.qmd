...
readme <- gsub("[VERSION]", params$L2_VERSION, readme, fixed = TRUE)
readme <- gsub("[DATESTAMP]", params$L2_RELEASE_DATE, readme, fixed = TRUE)
readme <- gsub("[OBSERVATIONS]", sum(smry$Values), readme, fixed = TRUE)
readme <- gsub("[GIT_COMMIT]", GIT_COMMIT, readme, fixed = TRUE)
readme <- gsub("[TIMEZONE]", params$L2_DATA_TIMEZONE, readme, fixed = TRUE)
